...
$result = mysqli_query($mysqli, "SELECT * FROM food_items WHERE CanteenID = 103");
$canteen = mysqli_query($mysqli, "SELECT * FROM canteen_info WHERE Cant_id = 103");
